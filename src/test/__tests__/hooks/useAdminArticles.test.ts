...
import { mockArticle, mockApiResponse, mockApiError } from '../../utils/test-utils';
...
describe('useAdminArticles', () => {
  ...
  describe('useAdminArticles', () => {
    ...
    it('devrait créer un nouvel article', async () => {
      ...
      mockApi.post.mockResolvedValue(mockApiResponse({ article: createdArticle }));
      ...
      expect(mockApi.post).toHaveBeenCalledWith('/admin/articles', newArticleData);
    });
    ...
    it('devrait mettre à jour un article existant', async () => {
      ...
      mockApi.put.mockResolvedValue(mockApiResponse({ article: updatedArticle }));
    ...
    it('devrait recharger les articles après une opération', async () => {
      ...
      mockApi.post.mockResolvedValue(mockApiResponse({ article: { ...mockArticle, ...newArticleData } }));
